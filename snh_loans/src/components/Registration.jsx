  ...
  return (
    <div className="absolute bg-[#0CA579] min-h-[910px] w-[1920px] ml-[-350px] mt-[-50px]">
      ...
      <img
        ...
        <h1 className='mt-[80px] ml-[1503px]'>Already have an account<span className='text-[#FFFFFF]'> <a href='login'>Login</a></span></h1>
        ...
        <div className="flex flex-col items-start mt-[100px] ml-[600px] space-y-8">
          ...
          <div className="text-left">
            <h3 className="text-6xl font-bold text-white mb-[100px] ml-[50px]">Get Started</h3>
            <h3 className="text-1xl font-bold text-white mt-[-50px] ml-[150px]">Fill in your Details</h3>
          </div>

          {/* Email Input (Outlined) */}
          <div className="relative h-11 w-64">
          <div class="w-full max-w-sm min-w-[533.33px]">
         <input class="w-full bg-[#FFFFFF] placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-3 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" placeholder="Fullname" />
         </div>
          </div>
         ...
         <input class="w-full bg-[#FFFFFF] placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-3 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" placeholder="Password" />
          ...
          <div className="relative h-11 w-64">
          <div class="w-full max-w-sm min-w-[533.33px]">
         <input class="w-full bg-[#FFFFFF] placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-3 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" placeholder="Confirm Password" />
         </div>
          </div>
